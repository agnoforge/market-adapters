...
// TestMain guards the rule that this package's harness only ever opens a
// database inside its own t.TempDir(): nothing may appear beside the package
// or at the repository root, where the real agnoforge.duckdb lives.

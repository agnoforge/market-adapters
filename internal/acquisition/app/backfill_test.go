...
func TestAppImportsNoAdapter(t *testing.T) {
	out, err := exec.Command("go", "list", "-deps", "github.com/agnos/agnoforge/internal/acquisition/app").Output()
	if err != nil {
		t.Fatalf("go list -deps: %v", err)
	}
	allowed := []string{"github.com/agnos/agnoforge/internal/acquisition/app", "github.com/agnos/agnoforge/internal/acquisition/domain"}
